...
class Home extends CI_Controller
{
    ...
    public function home()
    {
        ...
        $data['yeu'] = $this->Madmin->query_sql($select . " AND chuyenmuc IN  ('2','12','24') ORDER BY created_at DESC LIMIT 5");
        $data['dep'] = $this->Madmin->query_sql($select . " AND chuyenmuc IN ('4','16','17','18','19') ORDER BY created_at DESC LIMIT 5");
        $data['khoe'] = $this->Madmin->query_sql($select . " AND chuyenmuc IN ('6','25','27','28') ORDER BY created_at DESC LIMIT 5");
        $data['bep'] = $this->Madmin->query_sql($select . " AND chuyenmuc IN ('8','9','30','31') ORDER BY created_at DESC LIMIT 5");
        $data['lam_me'] = $this->Madmin->query_sql($select . " AND chuyenmuc IN ('11','15','29') ORDER BY created_at DESC LIMIT 5");
        $data['life_style'] = $this->Madmin->query_sql($select . " AND chuyenmuc = 22 ORDER BY created_at DESC LIMIT 5");
        $data['tam'] = $this->Madmin->query_sql($select . " AND chuyenmuc = 23 ORDER BY created_at DESC LIMIT 5");
        $data['tieu_dung'] = $this->Madmin->query_sql($select . " AND chuyenmuc IN ('38','39') ORDER BY created_at DESC LIMIT 5");
        $data['giai_tri'] = $giai_tri =  $this->Madmin->query_sql($select . " AND chuyenmuc = 40 ORDER BY created_at DESC LIMIT 5");
        $data['phong_su'] = $this->Madmin->query_sql($select . " AND chuyenmuc = 41 ORDER BY created_at DESC LIMIT 5");
        $data['ban_doc'] =  $this->Madmin->query_sql($select . " AND chuyenmuc = 42 ORDER BY created_at DESC LIMIT 5");
        $data['mat_ngu'] = $this->Madmin->query_sql($select . " AND chuyenmuc = 46 ORDER BY created_at DESC LIMIT 5");
        $data['yolo'] = $this->Madmin->query_sql($select . " AND chuyenmuc = 47 ORDER BY created_at DESC LIMIT 5");
        $data['nhac'] = $this->Madmin->query_sql($select . " AND chuyenmuc = 48 ORDER BY created_at DESC LIMIT 5");
        $where = '';
    ...
    public function author($alias)
    {
        ...
        if ($author == null) {
            ...
            $data['meta_title'] = $author['meta_title'];
            $data['meta_des'] = $author['meta_des'];
            $data['meta_key'] = $author['meta_key'];
