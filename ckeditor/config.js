...
CKEDITOR.editorConfig = function( config ) {
	...
	***/
	...
	// File hop le
	config.simpleuploads_acceptedExtensions ='doc|docx|xls|xlsx|ppt|pdf|txt|rar|zip|jpeg|JPEG|jpg|gif|png|bmp|webp|WEBP';
	
	// File anh hop le
	config.simpleuploads_imageExtensions = 'JPEG|jpeg|gif|png|bmp|jpg|webp|WEBP';
