	...
	CKEDITOR.editorConfig = function (config) {
        ...
        ***/
		...
		(config.filebrowserBrowseUrl =
			"https://phunuplus.vn/ckeditor/ckfinder/ckfinder.php"),
			(config.filebrowserUploadUrl =
				"https://phunuplus.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files"),
			(config.filebrowserImageUploadUrl =
				"https://phunuplus.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images"),
			(config.filebrowserFlashUploadUrl =
				"https://phunuplus.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash"),
			// My Plugin
			/*/		
            config.plugins =
            // Plugin
